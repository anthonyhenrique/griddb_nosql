...
def preco_com_desconto(preco_original, percentual_desconto):
    ...
    novo preço"""
    p = (percentual_desconto/100)*preco_original
    pn = preco_original - p
    return round(pn,2)
#DONE
...
def imprime_mes_por_extenso(data):
    """Faça um programa que solicite a data de nascimento (dd/mm/a
...
def main():
    ...
    test(dias_para_segundos(0, 0, 0 print('É azarado:'), 1), 1)
    test(dias_para_segundos(0, 0, 0 print('É azarado:'), 30), 30)
